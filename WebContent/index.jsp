    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <%}else if(session_id != null && !session_level.equals("10")){ %>
  				 ...
  				 <div class="amado-btn-group mt-30 mb-100">
                	<a href="/member/logout.do" class="btn amado-btn mb-15">로그아웃</a>
                	<a href="#" class="btn amado-btn active">회원수정</a>
            	</div>
  				          
            <%}else{ %>
            
             	 <div class="amado-btn-group mt-30 mb-100">
                	<a href="/member/login.jsp" class="btn amado-btn mb-15">로그인</a>
                	<a href="/member/join.jsp" class="btn amado-btn active">회원가입</a>
            	</div>
            ...
            <div class="cart-fav-search mb-100">
                ...
                <a href="/jjimList.do?id=<%=session_id %>" class="fav-nav"><img src="/img/core-img/favorites.png" alt=""> Favourite</a>
